            ...
            <div className="flex items-center space-x-2">
                ...
                <Dialog>
                    ...
                    <DialogContent className="max-w-2xl">
                        <DialogHeader>
                            <DialogTitle className="text-2xl font-bold text-primary">Terms & Conditions for Skineminence</DialogTitle>
                             <p className="text-sm text-muted-foreground">Last Updated: 09-12-2025</p>
                        </DialogHeader>
                        <ScrollArea className="h-[60vh] pr-4">
                            <div className="prose prose-zinc max-w-none dark:prose-invert">
                                <p>Welcome to Skineminence (“we”, “our”, “the platform”, or “the service”). By accessing or using Skineminence, you (“user”, “you”, or “your”) agree to the following Terms & Conditions. Please read them carefully before proceeding. If you do not agree to any part of these Terms, you must discontinue using the service immediately.</p>

                                <h2>1. Nature of the Service</h2>
                                <p>1.1 Skineminence is an AI-powered skin image analysis tool designed to provide general informational insights based on the images you upload.</p>
                                ...
                                <p>1.3 Skineminence does NOT provide medical advice, diagnosis, treatment, prescriptions, or professional medical services of any kind.</p>

                                <h2>2. No Medical Advice Disclaimer</h2>
                                <p>2.1 All information provided by Skineminence—including disease likelihoods, possible conditions, and suggested remedies—is for informational and educational purposes only.</p>
                                ...
                                <p>2.4 You understand that Skineminence does not hold any medical certifications, licenses, or permits, and is not legally authorized to practice medicine.</p>
                                ...
                                <p>4.3 Skineminence makes no guarantees regarding the accuracy, reliability, completeness, or timeliness of AI-generated results.</p>
                                ...
                                <p>5.1 Skineminence, its owners, developers, team members, and affiliates are not liable for:</p>
                                <ul>
                                ...
                                <p>5.2 By using the service, you agree that Skineminence is not responsible for any decisions you make after receiving AI-generated information.</p>
                                <p>5.3 Under no circumstances will Skineminence be liable for any direct, indirect, incidental, special, or consequential damages arising out of your use of the platform.</p>
                                ...
                                <p>7.1 Skineminence may collect and process uploaded skin images solely for analysis and service improvement.</p>
                                ...
                                <p>7.4 By uploading images, you grant Skineminence permission to use them for:</p>
                                <ul>
                                    <li>AI processing</li>
                                ...
                                <p>9.1 Skineminence may modify, update, suspend, or discontinue parts of or the entire service at any time without prior notice.</p>
                                ...
                                <p>11.1 Skineminence does not guarantee continuous, uninterrupted access to the platform.</p>
                                <p>11.2 Technical issues, upgrades, or external factors may cause service downtime.</p>

                                <h2>12. Consent</h2>
                                <p>By checking the “I Agree” box or using Skineminence, you confirm that:</p>
                                <ul>
